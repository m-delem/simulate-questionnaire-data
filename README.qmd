...
This repository also contains code to simulate data for the [Vividness of Visual Imagery Questionnaire (VVIQ)](https://bpspsychub.onlinelibrary.wiley.com/doi/10.1111/j.2044-8295.1973.tb01322.x). This task was pretty specific because the distribution of the VVIQ is not normal and I did not have precise statistical parameters from the literature, only general visual imagery prevalence data. According to [Wright et al., 2024](<https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2024.1454107/full>), the VVIQ distribution has the following
characteristics:
